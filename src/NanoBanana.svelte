<script lang="ts">
  ...
  const weatherConditions: { [key: string]: { day: WeatherLook; night: WeatherLook; food: FoodDetails; } } = {
    Clear: {
      day: { background: 'https://images.unsplash.com/photo-1590074899143-e6db8709d77f?q=80&w=2670&auto=format&fit=crop', icon: '☀️', overlay: 'overlay-clear-day' },
      night: { background: 'https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?q=80&w=2670&auto=format&fit=crop', icon: '🌙', overlay: 'overlay-clear-night' },
      food: { preText: '상쾌한 날엔 ', items: ['시원한 냉면', '과일주스', '신선한 샐러드'], postText: ' 어떠세요?'}
    },
    Clouds: {
      day: { background: 'https://images.unsplash.com/photo-1534088568595-a066f410bcda?q=80&w=2551&auto=format&fit=crop', icon: '☁️', overlay: 'overlay-clouds-day' },
      night: { background: 'https://images.unsplash.com/photo-1502480137941-a17282b9921c?q=80&w=2670&auto=format&fit=crop', icon: '☁️', overlay: 'overlay-clouds-night' },
      food: { preText: '구름 낀 날엔 ', items: ['따뜻한 라떼', '핫초코', '카푸치노'], postText: '와 함께.' }
    },
    Rain: {
      day: { background: 'https://images.unsplash.com/photo-1519692933481-e14e246f7d95?q=80&w=2670&auto=format&fit=crop', icon: '🌧️', overlay: 'overlay-rain-day' },
      night: { background: 'https://images.unsplash.com/photo-1534274988757-a28bf1a57c17?q=80&w=2535&auto=format&fit=crop', icon: '🌧️', overlay: 'overlay-rain-night' },
      food: { preText: '비 오는 날엔 뜨끈한 ', items: ['칼국수', '수제비', '부침개'], postText: '이죠!'}
    },
    Snow: {
      day: { background: 'https://images.unsplash.com/photo-1549472314-a3c054b059e9?q=80&w=2670&auto=format&fit=crop', icon: '❄️', overlay: 'overlay-snow-day' },
      night: { background: 'https://images.unsplash.com/photo-1613259534292-065556241b71?q=80&w=2670&auto=format&fit=crop', icon: '❄️', overlay: 'overlay-snow-night' },
      food: { preText: '눈 오는 날엔 ', items: ['따끈한 어묵탕', '달콤한 호떡', '김이 나는 찐빵'], postText: '으로 몸을 녹여보세요.' }
    },
    Thunderstorm: {
      day: { background: 'https://images.unsplash.com/photo-1580287894679-663ce1a588ba?q=80&w=2670&auto=format&fit=crop', icon: '⚡️', overlay: 'overlay-thunderstorm' },
      night: { background: 'https://images.unsplash.com/photo-1605727226514-5c9b33a75879?q=80&w=2532&auto=format&fit=crop', icon: '⚡️', overlay: 'overlay-thunderstorm' },
      food: { preText: '번개 치는 날엔 ', items: ['매운 짬뽕', '따끈한 부대찌개', '치킨에 맥주'], postText: ' 한 잔!'}
    },
    // Default uses the original banana image as a fallback
    Default: {
      day: { background: 'https://images.unsplash.com/photo-1528825871115-3581a5387919?q=80&w=2815&auto=format&fit=crop', icon: '🤔', overlay: 'overlay-default' },
      night: { background: 'https://images.unsplash.com/photo-1528825871115-3581a5387919?q=80&w=2815&auto=format&fit=crop', icon: '🤔', overlay: 'overlay-default' },
